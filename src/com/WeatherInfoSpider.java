...
public class WeatherInfoSpider
{
	public static void main(String args[]) throws Exception
	{
		...
		//2.1获取含有空气质量的信息
		String str1 = "wfelkfbnx";//正则表达式前缀
        String str2 = "\\)";//正则表达式后缀
        String regex1 = "(?<=" + str1 + ")(.*?)(?=" + str2 + ")";
        String subString1 = getRegexedString(oragMes, regex1);
		String str4 = "W3si";//正则表达式前缀
		String str5 = "'";//正则表达式后缀
		String regex2 = "(?<=" + str4 + ")(.*?)(?=" + str5 + ")";
		String subString2 = getRegexedString(subString1, regex2);
		StringBuffer str3 = new StringBuffer();
		str3.append(str4).append(subString2);
